...
["portuguese_morion", "Portuguese Morion", [("portuguese_morion", 0)], itp_merchandise|itp_type_head_armor,0, 600, weight(2.0)|abundance(250)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(6), imodbits_armor],
...
#0,weight(2.25)|abundance(90)|weapon_length(63)|thrust_damage(1,pierce)|max_ammo(4),imodbits_missile],f
